...
urlpatterns = [
    ...
    path("ajax/get/filter/tioanime/", anime_ajax.tioanime_filter, name="get_filter_data"),
    path("ajax/get/filter/latanime/", anime_ajax.latanime_filter, name="get_filter_data"),
