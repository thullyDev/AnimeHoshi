        ...
        function (d, g, p) {
          g.exports = function (c) {
            ...
            c.build = function (b, k, g) {
              ...
              for (w in k)
                k.hasOwnProperty(w) &&
                  ((m = B(k[w], y)), (h[w] = { pattern: A(m.source), names: m.xregexp.captureNames || [] }));
              b = B(b, y);
              var x = 0,
                v,
                q = 0,
              ...
              function (b, c, h) {
                ...
                if (k.inverseOf) {
                  ...
                  if (!l.hasOwnProperty(h))
                    throw new ReferenceError("Unicode token missing data " + b[0] + " -> " + k.inverseOf);
                  k = l[h];
                  m = !m;
                }
      ...
      9: [
        function (d, g, p) {
          ...
          function z(a, e) {
            ...
            c && (b = B(b + c));
            e.isInternalOnly ||
              (void 0 !== u.source && (E = u.source), null != u.flags && (h = c ? B(u.flags + c) : u.flags));
            return (a = A(
              ...
              for (E = E.flags; g < k.length; ) {
                do {
                  for (var l, m = k, p = E, q = g, r = c, v = b, w = I.length, x = m.charAt(q), y = null; w--; ) {
                    ...
                    if (
                      ...
                      y = { matchLength: l[0].length, output: t.handler.call(v, l, r, p), reparse: t.reparse };
                      break;
                    }
                  }
                ...
                t
                  ...
                  : ((t = f.exec(k, O[c], g, "sticky")[0]),
                    (d += t),
                    (g += t.length),
                    "[" === t && "default" === c ? (c = "class") : "]" === t && "class" === c && (c = "default"));
              }
              F[a][e] = {
          ...
          f.replace = function (a, b, c, d) {
            ...
            e
              ? ((b.xregexp = b.xregexp || {}),
                (u = b.xregexp[h] || (b.xregexp[h] = z(b, { addG: !!g, removeG: "one" === d, isInternalOnly: !0 }))))
